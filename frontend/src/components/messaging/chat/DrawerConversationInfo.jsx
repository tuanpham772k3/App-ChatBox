...
const DrawerConversationInfo = ({
  ...
  const { images } = useSelector((state) => state.conversations);

  const [openDrawerGallery, setOpenDrawerGallery] = useState(false);
  ...
  return (
    <>
      ...
      >
        <div className="h-full overflow-y-auto custom-scrollbar">
          ...
          <div className="px-4 py-3 border-b-4 border-[var(--color-border)]">
            ...
            <button
              onClick={() => setOpenDrawerGallery(true)}
          ...
          <div className="flex flex-col">
            ...
            <button
              onClick={() => setOpenModalLeaveGroup(true)}
              className="w-full flex items-center gap-2 p-4 text-sm hover:bg-[var(--color-hover)] rounded text-red-500"
            >
              <LogOut size={20} />
              <span>Rời nhóm</span>
      ...
      <DrawerMediaGallery
        open={openDrawerGallery}
        onClose={() => setOpenDrawerGallery(false)}
        images={images}
      />
